  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="max-w-lg mx-auto w-full px-4 py-6 space-y-5">
        <h1 className="text-xl font-bold text-gray-900">Моя банковская карта</h1>
            ...
            <div>
              ...
              <div className="flex justify-between items-end">
                ...
                <div className="text-right">
                  <p className="text-white/60 text-xs mb-1">СРОК ДЕЙСТВИЯ</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-5 space-y-4">
          <h2 className="font-bold text-gray-800">Данные карты</h2>
          ...
          <div className="flex justify-between items-center py-3 border-b border-gray-100">
            <span className="text-sm text-gray-600">Срок действия</span>
        ...
        <div className="bg-red-50 border border-red-200 rounded-2xl p-4 flex gap-3">
          ...
          <div>
            <p className="font-bold text-red-700 text-sm">Карта временно заблокирована</p>
            <p className="text-red-600 text-xs mt-1">
              Ваша карта заблокирована в связи с блокировкой вашего счёта. Свяжитесь с консультантом SBERBANK для разблокировки.
            </p>
          </div>
        </div>
    ...
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40">
      <div className="max-w-lg mx-auto flex justify-around py-2">
        {[
          ...
          { id: "carte", label: "Карта", icon: "💳" },
          { id: "profil", label: "Профиль", icon: "👤" },
